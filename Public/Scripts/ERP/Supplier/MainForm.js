// 供应商档案 - 主界面
Ext.define("ERP.Supplier.MainForm", {
    extend: "Ext.panel.Panel",
    initComponent: function () {
        var me = this;

        Ext.define("ERPSupplierCategory", {
        ...
        var store = Ext.create("Ext.data.Store", {
            ...
            proxy: {
                ...
                url: ERP.Const.BASE_URL + "Home/Supplier/supplierList",
                reader: {
                    root: 'supplierList',
        ...
        Ext.apply(me, {
            ...
            layout: "border",
            tbar: [
                {text: "新增供应商", iconCls: "ERP-button-add", handler: this.onAddSupplier, scope: this},
                {text: "新增供应商分类", iconCls: "ERP-button-add-detail", handler: this.onAddCategory, scope: this}
            ],
            items: [{
    ...
    onAddCategory: function () {
        var form = Ext.create("ERP.Supplier.CategoryEditForm", {
            parentForm: this
        });
    ...
    onDeleteCategory: function () {
        ...
        ERP.MsgBox.confirm(info, function () {
            ...
            el.mask("正在删除中...");
            Ext.Ajax.request({
                url: ERP.Const.BASE_URL + "Home/Supplier/deleteCategory",
                method: "POST",
    ...
    freshCategoryGrid: function (id) {
        ...
        Ext.Ajax.request({
            url: ERP.Const.BASE_URL + "Home/Supplier/categoryList",
            method: "POST",
    ...
    onAddSupplier: function () {
        if (this.categoryGrid.getStore().getCount() == 0) {
            ERP.MsgBox.showInfo("没有供应商分类，请先新增供应商分类");
            return;
        }

        var form = Ext.create("ERP.Supplier.SupplierEditForm", {
            parentForm: this
        });
    ...
    onEditSupplier: function () {
        ...
        if (item == null || item.length != 1) {
            ERP.MsgBox.showInfo("请选择要编辑的供应商");
            return;
        }
    ...
    onDeleteSupplier: function () {
        ...
        if (item == null || item.length != 1) {
            ERP.MsgBox.showInfo("请选择要删除的供应商");
            return;
        }
        ...
        ERP.MsgBox.confirm(info, function () {
            ...
            el.mask("正在删除中...");
            Ext.Ajax.request({
                url: ERP.Const.BASE_URL + "Home/Supplier/deleteSupplier",
                method: "POST",
