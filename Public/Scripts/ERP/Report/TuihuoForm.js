// 进销存报表
Ext.define("PSI.Report.TuihuoForm", {
    ...
    getMainGrid: function() {
        ...
        Ext.define(modelName, {
            ...
            fields: ["bizDT", "goodsCode","reason", "goodsBarCode", "goodsName", "reject_goods_count", "reject_goods_money","reject_goods_actual_count"]
        });
        var store = Ext.create("Ext.data.Store", {
            ...
            proxy: {
                ...
                url: ERP.Const.BASE_URL + "Home/Reports/TuihuoQueryData",
                reader: {
                    root: 'dataList',
        ...
        me.__mainGrid = Ext.create("Ext.grid.Panel", {
            ...
            columns: [
                ...
                {header: "退货数量", dataIndex: "reject_goods_count", menuDisabled: true, sortable: false},
                {header: "退货金额", dataIndex: "reject_goods_money", menuDisabled: true, sortable: false},
                {header: "实际入库", dataIndex: "reject_goods_actual_count", menuDisabled: true, sortable: false},
    ...
    getQueryParam: function() {
        ...
        var reason = Ext.getCmp("editReason").getValue();
        if(reason){
    ...
    onExport:function(){
      ...
      //console.warn(url);
      url = ERP.Const.BASE_URL + "Home/Reports/TuihuoQueryData?act=export" + send_parm + "&start=0&limit=1000";
      console.warn(url);
            window.open(url);
    }
});