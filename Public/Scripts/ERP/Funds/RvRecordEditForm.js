// 应收账款 - 收款记录
Ext.define("ERP.Funds.RvRecordEditForm", {
		...
		Ext.apply(me, {
			...
			items : [ {
				...
				items : [ {
					...
					name : "actMoney",
					id : "editActMoney",
					value:(me.getRvDetail().get("rvMoney") - me.getRvDetail().get("actMoney")),
					listeners : {
						specialkey : {
	...
	onWndShow : function() {
        ...
        Ext.Ajax.request({
            url: ERP.Const.BASE_URL + "Home/Funds/rvRecInfo",
            params: {
            },
            method: "POST",
	...
	onOK : function() {
		...
		f.submit({
			url : ERP.Const.BASE_URL + "Home/Funds/addRvRecord",
			method : "POST",
