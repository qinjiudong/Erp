// 现金收支查询界面
Ext.define("ERP.Funds.CashMainForm", {
	...
	getMainGrid: function() {
		...
		var store = Ext.create("Ext.data.Store", {
			...
			proxy : {
				...
				url : ERP.Const.BASE_URL + "Home/Funds/cashList",
				reader : {
					root : 'dataList',
	...
	getDetailGrid: function() {
		...
		var store = Ext.create("Ext.data.Store", {
			...
			proxy : {
				...
				url : ERP.Const.BASE_URL + "Home/Funds/cashDetailList",
				reader : {
					root : 'dataList',
					totalProperty : 'totalCount'
				}
		...
		me.__detailGrid = Ext.create("Ext.grid.Panel", {
			...
			columns : [ {
				...
				renderer: function(value, md, record) {
					return "<a href='" + ERP.Const.BASE_URL + "Home/Bill/viewIndex?fid=2024&refType=" 
