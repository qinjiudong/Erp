// 退换货入库单-选择销售出库单界面
Ext.define("ERP.Sale.SRSelectWSBillForm", {
    ...
    getWSBillGrid: function() {
        ...
        Ext.define(modelName, {
            ...
            fields: ["id", "ref", "bizDate", "customerName", "warehouseName", "tel",
                "inputUserName", "bizUserName", "amount","sale_money","remark","bill_status_str"]
        });
