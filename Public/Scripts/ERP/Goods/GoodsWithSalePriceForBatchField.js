Ext.define("ERP.Goods.GoodsField", {
    ...
    alias: "widget.jyerp_goods_with_saleprice_field",
    ...
    onTriggerClick: function (e) {
        ...
        Ext.define(modelName, {
            ...
            fields: ["id", "code", "name", "spec", "unitName", "salePrice", "unitNamePW"]
        });
        ...
        var lookupGrid = Ext.create("Ext.grid.Panel", {
            ...
            columns: [
                ...
                { header: "单位", dataIndex: "unitNamePW", menuDisabled: true, width: 60 },
        ...
        editName.on("change", function () {
            ...
            Ext.Ajax.request({
                url: ERP.Const.BASE_URL + "Home/Goods/queryDataWithSalePrice",
                params: {
