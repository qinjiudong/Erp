// 损溢单
Ext.define("ERP.InvLoss.ITEditForm", {
    ...
    onWndShow: function () {
        ...
        Ext.Ajax.request({
            url: ERP.Const.BASE_URL + "Home/InvLoss/itBillInfo",
            params: {
    ...
    onOK: function () {
        ...
        Ext.Ajax.request({
            url: ERP.Const.BASE_URL + "Home/InvLoss/editITBill",
            method: "POST",
    ...
    getGoodsGrid: function () {
        ...
        Ext.define(modelName, {
            extend: "Ext.data.Model",
            fields: ["id", "goodsId", "goodsCode", "goodsName", "goodsSpec", "unitName", "goodsCount", "bill_type"]
        });
        ...
        me.__goodsGrid = Ext.create("Ext.grid.Panel", {
            ...
            columns: [
                ...
                {header: "数量", dataIndex: "goodsCount", menuDisabled: true,
                    sortable: false, align: "right", width: 100,
                    editor: {xtype: "numberfield",
                        allowDecimals: true,
                        hideTrigger: true}
                },
                {header: "损溢类型", dataIndex: "bill_type", menuDisabled: true,
                    sortable: false, align: "right", width: 100,
                    editor: {xtype : "combo", queryMode : "local",editable : false,	valueField : "text",
                ...
                {header: "进价", dataIndex: "goodsPrice", menuDisabled: true,
                    sortable: false, align: "right", width: 100,
                    editor: {xtype: "numberfield",
                        allowDecimals: true,
                        hideTrigger: true}
                },
                {header: "金额", dataIndex: "goodsMoney", menuDisabled: true,
                    sortable: false, align: "right", width: 100,
                    editor: {xtype: "numberfield",
                        allowDecimals: true,
                        hideTrigger: true}
    ...
    __setGoodsInfo: function (data) {
        ...
        goods.set("bill_type", data.bill_type);
