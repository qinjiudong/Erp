// 库间调拨 - 主界面
Ext.define("ERP.InvTransfer.InvTransferMainForm", {
    ...
    // 新增调拨单
    onAddBill: function () {
    	var form = Ext.create("ERP.InvTransfer.ITEditForm", {
    		parentForm: this
    	});
    ...
    onEditBill: function () {
        ...
        if (item == null || item.length != 1) {
            ERP.MsgBox.showInfo("请选择要编辑的调拨单");
            return;
        }
        var bill = item[0];
    ...
    onDeleteBill: function () {
        ...
        var item = me.getMainGrid().getSelectionModel().getSelection();
        if (item == null || item.length != 1) {
            ERP.MsgBox.showInfo("请选择要删除的调拨单");
            return;
        }
        var bill = item[0];
        ...
        ERP.MsgBox.confirm(info, function () {
            ...
            el.mask("正在删除中...");
            Ext.Ajax.request({
                url: ERP.Const.BASE_URL + "Home/InvTransfer/DeleteITBills",
                method: "POST",
                params: {
                    id: bill.get("id")
                },
    ...
    onCommit: function () {
        ...
        var item = me.getMainGrid().getSelectionModel().getSelection();
        if (item == null || item.length != 1) {
            ERP.MsgBox.showInfo("没有选择要提交的调拨单");
            return;
        }
        var bill = item[0];
        ...
        if (detailCount == 0) {
            ERP.MsgBox.showInfo("当前调拨单没有录入商品明细，不能提交");
            return;
        }
        ...
        ERP.MsgBox.confirm(info, function () {
            ...
            el.mask("正在提交中...");
            Ext.Ajax.request({
                url: ERP.Const.BASE_URL + "Home/InvTransfer/commitITBill",
                method: "POST",
    ...
    getMainGrid: function() {
        ...
        var store = Ext.create("Ext.data.Store", {
            ...
            proxy: {
                ...
                url: ERP.Const.BASE_URL + "Home/InvTransfer/itbillList",
                reader: {
                    root: 'dataList',
    ...
    refreshDetailGrid: function (id) {
        ...
        Ext.Ajax.request({
            url: ERP.Const.BASE_URL + "Home/InvTransfer/itBillDetailList",
            params: {
                id: bill.get("id")
            },
            method: "POST",
