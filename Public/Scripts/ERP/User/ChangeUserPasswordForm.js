// 修改用户密码
Ext.define("ERP.User.ChangeUserPasswordForm", {
    ...
    onOK: function () {
        ...
        if (pass != pass2) {
            ERP.MsgBox.showInfo("输入的密码和确认密码不一致，请重新输入", function () {
        ...
        el.mask("数据保存中...");
        f.submit({
            url: ERP.Const.BASE_URL + "Home/User/changePassword",
            method: "POST",
            success: function (form, action) {
                el.unmask();
                ERP.MsgBox.showInfo("成功修改密码", function () {
                    me.close();
                });
            },
