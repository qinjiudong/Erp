// 修改我的密码
Ext.define("ERP.User.ChangeMyPasswordForm", {
        ...
        Ext.apply(me, {
            items: [{
                ...
                items: [{
                    ...
                    buttons: [{
                        id: "buttonOK",
                        text: "修改密码", formBind: true, handler: this.onOK, scope: this, iconCls: "ERP-button-ok"
                    }, {
    ...
    onOK: function () {
        ...
        if (np != cp) {
            ERP.MsgBox.showInfo("确认密码与新密码不一致", function () {
        ...
        var el = Ext.getBody();
        form.submit({
            url: ERP.Const.BASE_URL + "Home/User/changeMyPasswordPOST",
            method: "POST",
            success: function (form, action) {
                el.unmask();
                ERP.MsgBox.showInfo("成功修改登录密码", function () {
                    location.replace(ERP.Const.BASE_URL);
                });
            },
            failure: function (form, action) {
                el.unmask();
                ERP.MsgBox.showInfo(action.result.msg);
            }
        });
    },
