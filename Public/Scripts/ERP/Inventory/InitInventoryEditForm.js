// 库存建账 - 编辑界面
Ext.define("ERP.Inventory.InitInventoryEditForm", {
            ...
            items: [
                {
                    ...
                    items: [{
                            ...
                            items: [{
                                    ...
                                    title: "编辑区", xtype: "panel", region: "east", width: 400, split: true, collajyerpble: true,
                                    items: [{
                                            xtype: "form",
                                            layout: "form",
                                            border: 0,
                                            ...
                                            items: [{xtype: "container", flex: 1}, {
                                                    id: "buttonSubmit",
                                                    xtype: "button", text: "保存当前商品的建账信息", iconCls: "ERP-button-ok", flex: 2,
    ...
    getGoodsGrid: function () {
        ...
        var store = Ext.create("Ext.data.Store", {
            ...
            proxy: {
                ...
                url: ERP.Const.BASE_URL + "Home/InitInventory/goodsList",
                reader: {
                    root: 'goodsList',
    ...
    getGoodsCategories: function () {
        ...
        Ext.Ajax.request({
            url: ERP.Const.BASE_URL + "Home/InitInventory/goodsCategoryList",
            method: "POST",
    ...
    onSave: function () {
        ...
        Ext.Ajax.request({
            url: ERP.Const.BASE_URL + "Home/InitInventory/commitInitInventoryGoods",
            params: {
                ...
                if (success) {
                    ...
                    if (result.success) {
                        ...
                        if (!Ext.getCmp("checkboxGotoNext").getValue()) {
                            ERP.MsgBox.showInfo("数据成功保存");
                        } else {
                            me.gotoNext();
                        }
                    } else {
                        ERP.MsgBox.showInfo(result.msg, function () {
                            Ext.getCmp("editGoodsCount").focus();
                        });
                    }
                }
