// 库存账查询 - 主界面
Ext.define("ERP.Inventory.InvQueryMainForm", {
	...
	initComponent : function() {
		...
		Ext.define("ERPInventory", {
			extend : "Ext.data.Model",
			fields : [ "id", "goodsId", "goodsCode", "goodsName", "goodsSpec","barCode",
					"unitName", "inCount", "inPrice", "inMoney", "outCount",
					"outPrice", "outMoney", "balanceCount", "balancePrice","lastPrice",
					"balanceMoney" ]
		});

		Ext.define("ERPInventoryDetail", {
			extend : "Ext.data.Model",
			fields : [ "id", "goodsCode", "goodsName", "goodsSpec", "unitName",
					"inCount", "inPrice", "inMoney", "outCount", "outPrice",
					"outMoney", "balanceCount", "balancePrice", "balanceMoney","lastPrice",
		...
		me.__queryEditNameList = ["editQueryCode", "editQueryName", "editQuerySpec", "editQueryBarCode", "editQuerySupplier"];
	...
	refreshWarehouseGrid : function() {
		...
		Ext.Ajax.request({
			url : ERP.Const.BASE_URL + "Home/Inventory/warehouseList",
			method : "POST",
	...
	getInventoryGrid : function() {
		...
		var store = Ext.create("Ext.data.Store", {
			...
			proxy : {
				...
				url : ERP.Const.BASE_URL + "Home/Inventory/inventoryList",
				reader : {
					root : 'dataList',
	...
	getInventoryDetailGrid : function() {
		...
		var store = Ext.create("Ext.data.Store", {
			...
			proxy : {
				...
				url : ERP.Const.BASE_URL + "Home/Inventory/inventoryDetailList",
				reader : {
					root : 'details',
					totalProperty : 'totalCount'
				}
	...
	getInventoryGridParam: function () {
		...
		var supplier = Ext.getCmp("editQuerySupplier").getValue();
		if(supplier){
			result.supplier = supplier;
		}
		var category = Ext.getCmp("editQueryCategory").getValue();
		if(category){
