// 库间损溢 - 主界面
Ext.define("ERP.Inventory.InvTransferMainForm", {
    ...
    onDeleteBill: function () {
        ...
        ERP.MsgBox.confirm(info, function () {
            ...
            el.mask("正在删除中...");
            Ext.Ajax.request({
                url: ERP.Const.BASE_URL + "Home/Inventory/deleteITBill",
                method: "POST",
                params: {
                    id: bill.get("id")
                },
    ...
    onCommit: function () {
        ...
        ERP.MsgBox.confirm(info, function () {
            ...
            el.mask("正在提交中...");
            Ext.Ajax.request({
                url: ERP.Const.BASE_URL + "Home/Inventory/commitITBill",
                method: "POST",
    ...
    getMainGrid: function() {
        ...
        var store = Ext.create("Ext.data.Store", {
            ...
            proxy: {
                ...
                url: ERP.Const.BASE_URL + "Home/Inventory/itbillList",
                reader: {
                    root: 'dataList',
    ...
    refreshDetailGrid: function (id) {
        ...
        Ext.Ajax.request({
            url: ERP.Const.BASE_URL + "Home/Inventory/itBillDetailList",
            params: {
                id: bill.get("id")
            },
            method: "POST",
