...
<script src="<?php echo ($uri); ?>Public/Scripts/ERP/Purchase/PurchaseField.js?dt=<?php echo ($dtFlag); ?>" type="text/javascript"></script>

<script src="<?php echo ($uri); ?>Public/Scripts/ERP/InvAcceptance/IAMainForm.js?dt=<?php echo ($dtFlag); ?>" type="text/javascript"></script>
<script src="<?php echo ($uri); ?>Public/Scripts/ERP/InvAcceptance/IAEditForm.js?dt=<?php echo ($dtFlag); ?>" type="text/javascript"></script>
...
<script>
    Ext.onReady(function(){
        ...
        app.add(Ext.create("ERP.Purchase.IAMainForm"));
        app.setAppHeader({
