...
<script src="<?php echo ($uri); ?>Public/Scripts/ERP/Home/MainForm.js?dt=<?php echo ($dtFlag); ?>" type="text/javascript"></script>
<script>
    Ext.onReady(function(){
        ...
        app.add(Ext.create("ERP.Home.MainForm",{
            pSale: "1",
            pInventory: "1",
            pPurchase: "1",
            pMoney: "1"
