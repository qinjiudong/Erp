...
<script src="<?php echo ($uri); ?>Public/Scripts/ERP/Customer/CustomerField.js?dt=<?php echo ($dtFlag); ?>" type="text/javascript"></script>
<script src="<?php echo ($uri); ?>Public/Scripts/ERP/Goods/GoodsWithSalePriceField.js?dt=<?php echo ($dtFlag); ?>" type="text/javascript"></script>

<script src="<?php echo ($uri); ?>Public/Scripts/ERP/Sale/PickMainForm.js?dt=<?php echo ($dtFlag); ?>" type="text/javascript"></script>
<script src="<?php echo ($uri); ?>Public/Scripts/ERP/Sale/PickEditForm.js?dt=<?php echo ($dtFlag); ?>" type="text/javascript"></script>
<script src="<?php echo ($uri); ?>Public/Scripts/ERP/Sale/SiteEditForm.js?dt=<?php echo ($dtFlag); ?>" type="text/javascript"></script>
<script src="<?php echo ($uri); ?>Public/Scripts/ERP/Site/SiteField.js?dt=<?php echo ($dtFlag); ?>" type="text/javascript"></script>
...
<script>
    Ext.onReady(function(){
        ...
        app.add(Ext.create("ERP.Sale.PickMainForm"));
        app.setAppHeader({
