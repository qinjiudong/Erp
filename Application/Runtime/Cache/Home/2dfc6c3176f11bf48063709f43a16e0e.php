...
<script src="<?php echo ($uri); ?>Public/Scripts/ERP/Sale/RSMainForm.js?dt=<?php echo ($dtFlag); ?>" type="text/javascript"></script>
<script src="<?php echo ($uri); ?>Public/Scripts/ERP/Sale/RSEditForm.js?dt=<?php echo ($dtFlag); ?>" type="text/javascript"></script>
<script src="<?php echo ($uri); ?>Public/Scripts/ERP/Sale/RSSelectWSBillForm.js?dt=<?php echo ($dtFlag); ?>" type="text/javascript"></script>
...
<script>
    Ext.onReady(function(){
        ...
        app.add(Ext.create("ERP.Sale.RSMainForm"));
        app.setAppHeader({
