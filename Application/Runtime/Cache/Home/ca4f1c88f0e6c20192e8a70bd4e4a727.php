...
<script src="<?php echo ($uri); ?>Public/Scripts/ERP/Bizlog/MainForm.js?dt=<?php echo ($dtFlag); ?>" type="text/javascript"></script>
<script>
    Ext.onReady(function(){
        ...
        app.add(Ext.create("ERP.Bizlog.MainForm"));
        app.setAppHeader({
            title: "<?php echo ($title); ?>",
            iconCls: "ERP-fid-8997"
            });
    });
</script>
    </body>
