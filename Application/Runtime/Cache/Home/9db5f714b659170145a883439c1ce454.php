...
<script src="<?php echo ($uri); ?>Public/Scripts/ERP/Goods/GoodsPCField.js?dt=<?php echo ($dtFlag); ?>" type="text/javascript"></script>


<script src="<?php echo ($uri); ?>Public/Scripts/ERP/Processiong/PCMainForm.js?dt=<?php echo ($dtFlag); ?>" type="text/javascript"></script>
<script src="<?php echo ($uri); ?>Public/Scripts/ERP/Processiong/PCEditForm.js?dt=<?php echo ($dtFlag); ?>" type="text/javascript"></script>
...
<script>
    Ext.onReady(function(){
        ...
        app.add(Ext.create("ERP.Purchase.PCMainForm"));
        app.setAppHeader({
