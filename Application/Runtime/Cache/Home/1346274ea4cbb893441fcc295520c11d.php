...
<script src="<?php echo ($uri); ?>Public/Scripts/ERP/Purchase/PWMainForm.js?dt=<?php echo ($dtFlag); ?>" type="text/javascript"></script>
<script src="<?php echo ($uri); ?>Public/Scripts/ERP/Purchase/PWEditForm.js?dt=<?php echo ($dtFlag); ?>" type="text/javascript"></script>
...
var LODOP; //声明为全局变量
    Ext.onReady(function(){
        ...
        app.add(Ext.create("ERP.Purchase.PWMainForm"));
        app.setAppHeader({
