...
<script src="<?php echo ($uri); ?>Public/Scripts/ERP/PurchaseRej/PRMainForm.js?dt=<?php echo ($dtFlag); ?>" type="text/javascript"></script>
<script src="<?php echo ($uri); ?>Public/Scripts/ERP/PurchaseRej/PREditForm.js?dt=<?php echo ($dtFlag); ?>" type="text/javascript"></script>
<script src="<?php echo ($uri); ?>Public/Scripts/ERP/PurchaseRej/PRSelectPWBillForm.js?dt=<?php echo ($dtFlag); ?>" type="text/javascript"></script>
...
<script>
    Ext.onReady(function(){
        ...
        app.add(Ext.create("ERP.PurchaseRej.PRMainForm"));
        app.setAppHeader({
