...
<script src="<?php echo ($uri); ?>Public/Scripts/ERP/BizConfig/MainForm.js?dt=<?php echo ($dtFlag); ?>" type="text/javascript"></script>
<script src="<?php echo ($uri); ?>Public/Scripts/ERP/BizConfig/EditForm.js?dt=<?php echo ($dtFlag); ?>" type="text/javascript"></script>
<script>
    Ext.onReady(function(){
        ...
        app.add(Ext.create("ERP.BizConfig.MainForm"));
        app.setAppHeader({
