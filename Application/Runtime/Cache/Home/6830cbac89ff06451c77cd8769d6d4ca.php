...
<script src="<?php echo ($uri); ?>Public/Scripts/ERP/User/ParentOrgEditor.js?dt=<?php echo ($dtFlag); ?>" type="text/javascript"></script>
<script src="<?php echo ($uri); ?>Public/Scripts/ERP/User/OrgEditor.js?dt=<?php echo ($dtFlag); ?>" type="text/javascript"></script>

<script src="<?php echo ($uri); ?>Public/Scripts/ERP/User/MainForm.js?dt=<?php echo ($dtFlag); ?>" type="text/javascript"></script>
<script src="<?php echo ($uri); ?>Public/Scripts/ERP/User/OrgEditForm.js?dt=<?php echo ($dtFlag); ?>" type="text/javascript"></script>
<script src="<?php echo ($uri); ?>Public/Scripts/ERP/User/UserEditForm.js?dt=<?php echo ($dtFlag); ?>" type="text/javascript"></script>
<script src="<?php echo ($uri); ?>Public/Scripts/ERP/User/ChangeUserPasswordForm.js?dt=<?php echo ($dtFlag); ?>" type="text/javascript"></script>
...
<script>
    Ext.onReady(function(){
        ...
        app.add(Ext.create("ERP.User.MainForm"));
        app.setAppHeader({
            title: "<?php echo ($title); ?>",
            iconCls: "ERP-fid-8999"
            });
